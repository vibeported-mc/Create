...
public class SailBlock extends WrenchableDirectionalBlock {
	...
	/**
	 * Sails are springy, sail frames are not. 26.2 has the entity apply the bounce itself from the
	 * block's restitution, so what used to be a custom bounce is just this number; the entity already
	 * handles suppressed bounces and the non-living scaling that came with it.
	 */
	@Override
