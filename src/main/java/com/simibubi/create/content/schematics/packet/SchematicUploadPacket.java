...
public record SchematicUploadPacket(int code, long size, String schematic, byte[] data) implements SelfHandlingPayload {
	...
	public Type<? extends CustomPacketPayload> type() {
		return AllPackets.UPLOAD_SCHEMATIC.getType();
	}
