...
public final class CreateMillingRecipeGen extends MillingRecipeGen {
	...
	BONE = create(() -> Items.BONE, b -> b.duration(100)
		...
		.output(.25f, Items.DYE.pick(DyeColor.WHITE), 1)
		.output(.25f, Items.BONE_MEAL, 3)),

	CACTUS = create(() -> Blocks.CACTUS, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.GREEN), 2)
		.output(.1f, Items.DYE.pick(DyeColor.GREEN), 1)),

	SEA_PICKLE = create(() -> Blocks.SEA_PICKLE, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.LIME), 2)
		.output(.1f, Items.DYE.pick(DyeColor.GREEN))),

	BONE_MEAL = create(() -> Items.BONE_MEAL, b -> b.duration(70)
		.output(Items.DYE.pick(DyeColor.WHITE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.LIGHT_GRAY), 1)),

	COCOA_BEANS = create(() -> Items.COCOA_BEANS, b -> b.duration(70)
		.output(Items.DYE.pick(DyeColor.BROWN), 2)
		.output(.1f, Items.DYE.pick(DyeColor.BROWN), 1)),
	...
	BEETROOT = create(() -> Items.BEETROOT, b -> b.duration(70)
		.output(Items.DYE.pick(DyeColor.RED), 2)
		.output(.1f, Items.BEETROOT_SEEDS)),

	INK_SAC = create(() -> Items.INK_SAC, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.BLACK), 2)
		.output(.1f, Items.DYE.pick(DyeColor.GRAY))),

	CHARCOAL = create(() -> Items.CHARCOAL, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.BLACK), 1)
		.output(.1f, Items.DYE.pick(DyeColor.GRAY), 2)),

	COAL = create(() -> Items.COAL, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.BLACK), 2)
		.output(.1f, Items.DYE.pick(DyeColor.GRAY), 1)),

	LAPIS_LAZULI = create(() -> Items.LAPIS_LAZULI, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.BLUE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.BLUE))),

	AZURE_BLUET = create(() -> Blocks.AZURE_BLUET, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.LIGHT_GRAY), 2)
		.output(.1f, Items.DYE.pick(DyeColor.WHITE), 2)),

	BLUE_ORCHID = create(() -> Blocks.BLUE_ORCHID, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.LIGHT_BLUE), 2)
		.output(.05f, Items.DYE.pick(DyeColor.LIGHT_GRAY), 1)),

	FERN = create(() -> Blocks.FERN, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.GREEN))
		.output(.1f, Items.WHEAT_SEEDS)),

	LARGE_FERN = create(() -> Blocks.LARGE_FERN, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.GREEN), 2)
		.output(.5f, Items.DYE.pick(DyeColor.GREEN))
		.output(.1f, Items.WHEAT_SEEDS)),

	LILAC = create(() -> Blocks.LILAC, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.MAGENTA), 3)
		.output(.25f, Items.DYE.pick(DyeColor.MAGENTA))
		.output(.25f, Items.DYE.pick(DyeColor.PURPLE))),

	PEONY = create(() -> Blocks.PEONY, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.PINK), 3)
		.output(.25f, Items.DYE.pick(DyeColor.MAGENTA))
		.output(.25f, Items.DYE.pick(DyeColor.PINK))),

	ALLIUM = create(() -> Blocks.ALLIUM, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.MAGENTA), 2)
		.output(.1f, Items.DYE.pick(DyeColor.PURPLE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.PINK))),

	LILY_OF_THE_VALLEY = create(() -> Blocks.LILY_OF_THE_VALLEY, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.WHITE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.LIME))
		.output(.1f, Items.DYE.pick(DyeColor.WHITE))),

	ROSE_BUSH = create(() -> Blocks.ROSE_BUSH, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.RED), 3)
		.output(.05f, Items.DYE.pick(DyeColor.GREEN), 2)
		.output(.25f, Items.DYE.pick(DyeColor.RED), 2)),

	SUNFLOWER = create(() -> Blocks.SUNFLOWER, b -> b.duration(100)
		.output(Items.DYE.pick(DyeColor.YELLOW), 3)
		.output(.25f, Items.DYE.pick(DyeColor.ORANGE))
		.output(.25f, Items.DYE.pick(DyeColor.YELLOW))),

	OXEYE_DAISY = create(() -> Blocks.OXEYE_DAISY, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.LIGHT_GRAY), 2)
		.output(.2f, Items.DYE.pick(DyeColor.WHITE))
		.output(.05f, Items.DYE.pick(DyeColor.YELLOW))),

	POPPY = create(() -> Blocks.POPPY, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.RED), 2)
		.output(.05f, Items.DYE.pick(DyeColor.GREEN))),

	DANDELION = create(() -> Blocks.DANDELION, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.YELLOW), 2)
		.output(.05f, Items.DYE.pick(DyeColor.YELLOW))),
	...
	WITHER_ROSE = create(() -> Blocks.WITHER_ROSE, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.BLACK), 2)
		.output(.1f, Items.DYE.pick(DyeColor.BLACK))),

	ORANGE_TULIP = create(() -> Blocks.ORANGE_TULIP, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.ORANGE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.LIME))),
	...
	PINK_TULIP = create(() -> Blocks.PINK_TULIP, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.PINK), 2)
		.output(.1f, Items.DYE.pick(DyeColor.LIME))),
	...
	PITCHER_PLANT = create(() -> Blocks.PITCHER_PLANT, b -> b.duration(50)
		.output(Items.DYE.pick(DyeColor.CYAN), 4)
		.output(.1f, Items.DYE.pick(DyeColor.PURPLE))),
	...
	ATMO_GILIA = create(Mods.ATM.recipeId("gilia"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.PURPLE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.MAGENTA), 2)
		.output(.1f, Items.DYE.pick(DyeColor.PINK))
	...
	ATMO_HOT_BRUSH = create(Mods.ATM.recipeId("hot_monkey_brush"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.ORANGE), 2)
		.output(.05f, Items.DYE.pick(DyeColor.RED))
		.output(.05f, Items.DYE.pick(DyeColor.YELLOW))
		.whenModLoaded(Mods.ATM.getId())),
	...
	ATMO_SCALDING_BRUSH = create(Mods.ATM.recipeId("scalding_monkey_brush"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.RED), 2)
		.output(.1f, Items.DYE.pick(DyeColor.RED), 2)
		.output(.1f, Items.DYE.pick(DyeColor.ORANGE))
		.whenModLoaded(Mods.ATM.getId())),

	ATMO_WARM_BRUSH = create(Mods.ATM.recipeId("warm_monkey_brush"), b -> b.duration(50)
		.require(Mods.ATM, "warm_monkey_brush")
		.output(Items.DYE.pick(DyeColor.YELLOW), 2)
		.output(.1f, Items.DYE.pick(DyeColor.YELLOW), 2)
		.output(.1f, Items.DYE.pick(DyeColor.ORANGE))
		.whenModLoaded(Mods.ATM.getId())),
	...
	ATMO_YUCCA_FLOWER = create(Mods.ATM.recipeId("yucca_flower"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.LIGHT_GRAY), 2)
		.output(.05f, Items.DYE.pick(DyeColor.WHITE))
		.whenModLoaded(Mods.ATM.getId())),

	ATMO_TALL_YUCCA_FLOWER = create(Mods.ATM.recipeId("tall_yucca_flower"), b -> b.duration(50)
		.require(Mods.ATM, "tall_yucca_flower")
		.output(Items.DYE.pick(DyeColor.LIGHT_GRAY), 3)
		.output(0.25f, Items.DYE.pick(DyeColor.LIGHT_GRAY), 2)
		.output(.05f, Items.DYE.pick(DyeColor.WHITE), 2)
		.whenModLoaded(Mods.ATM.getId())),

	ATMO_FIRETHORN = create(Mods.ATM.recipeId("firethorn"), b -> b.duration(50)
		.require(Mods.ATM, "firethorn")
		.output(Items.DYE.pick(DyeColor.RED), 2)
		.output(.1f, Items.DYE.pick(DyeColor.ORANGE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.GREEN))
		.whenModLoaded(Mods.ATM.getId())),
	...
	ATMO_FORSYTHIA = create(Mods.ATM.recipeId("forsythia"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.YELLOW), 2)
		.output(.1f, Items.DYE.pick(DyeColor.LIME), 2)
		.output(.1f, Items.DYE.pick(DyeColor.YELLOW))
		.whenModLoaded(Mods.ATM.getId())),

	ATMO_CACTUS = create(Mods.ATM.recipeId("barrel_cactus"), b -> b.duration(50)
		.require(Mods.ATM, "barrel_cactus")
		.output(Items.DYE.pick(DyeColor.ORANGE), 2)
		.output(.1f, Items.DYE.pick(DyeColor.GREEN), 3)
		.whenModLoaded(Mods.ATM.getId())),

	ATMO_HYACINTH = create(Mods.ATM.recipeId("water_hyacinth"), b -> b.duration(50)
		.require(Mods.ATM, "water_hyacinth")
		.output(Items.DYE.pick(DyeColor.PURPLE), 3)
		.output(0.25f, Items.DYE.pick(DyeColor.LIME), 2)
		.output(.05f, Items.DYE.pick(DyeColor.BROWN), 2)
		.whenModLoaded(Mods.ATM.getId())),
	...
	AUTUM_CROCUS = create(Mods.AUTUM.recipeId("autumn_crocus"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.MAGENTA), 2)
		.output(.1f, Items.DYE.pick(DyeColor.PINK), 2)
		.output(.1f, Items.DYE.pick(DyeColor.PURPLE))
		.whenModLoaded(Mods.AUTUM.getId())),

	// Biomes O' Plenty
	BOP_HYDRANGEA = bopFlower("blue_hydrangea", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.LIGHT_BLUE)), List.of(3, 2, 2)),

	BOP_GOLDENROD = bopFlower("goldenrod", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.GREEN)), List.of(3, 2, 2)),

	BOP_BLOSSOM = bopFlower("burning_blossom", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),

	BOP_GLOWFLOWER = bopFlower("glowflower", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.CYAN), Items.DYE.pick(DyeColor.WHITE)), List.of(2, 1)),

	BOP_LAVENDER = bopFlower("lavender", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BOP_TALL_LAVENDER = bopFlower("tall_lavender", List.of(1f, 0.25f, .05f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.GREEN)), List.of(3, 2, 2)),

	BOP_WHITE_LAVENDER = bopFlower("white_lavender", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BOP_TALL_WHITE_LAVENDER = bopFlower("tall_white_lavender", List.of(1f, 0.25f, .05f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.GREEN)), List.of(3, 2, 2)),

	BOP_COSMOS = bopFlower("orange_cosmos", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),

	BOP_DAFFODIL = bopFlower("pink_daffodil", List.of(1f, .25f, .05f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.CYAN)), List.of(2, 1, 1)),

	BOP_HIBISCUS = bopFlower("pink_hibiscus", List.of(1f, .25f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1, 1)),

	BOP_ROSE = bopFlower("rose", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BOP_VIOLET = bopFlower("violet", 1f, Items.DYE.pick(DyeColor.PURPLE), 2),

	BOP_WILDFLOWER = bopFlower("wildflower", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),

	BOP_PETALS = bopFlower("white_petals", 1f, Items.DYE.pick(DyeColor.WHITE), 2),

	BOP_IRIS = bopFlower("icy_iris", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.LIGHT_GRAY), Items.DYE.pick(DyeColor.LIGHT_BLUE)), List.of(3, 2, 2)),

	BOP_LILY = bopFlower("wilted_lily", 1f, Items.DYE.pick(DyeColor.GRAY), 2),

	BOP_ENDBLOOM = bopFlower("endbloom", 1f, Items.DYE.pick(DyeColor.LIGHT_GRAY), 2),

	BOP_WATERLILY = bopFlower("waterlily", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.PINK)), List.of(2, 1)),

	BOP_CACTUS = bopFlower("tiny_cactus", List.of(1f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BOP_CATTAIL = bopFlower("cattail", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.BROWN), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.BROWN)), List.of(3, 2, 2)),
	...
	BWG_ALLIUM_BUSH = bwgFlower("allium_flower_bush", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.MAGENTA)), List.of(3, 2, 2)),

	BWG_BELLFLOWER = bwgFlower("alpine_bellflower", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 2, 1)),

	BWG_AMARANTH = bwgFlower("amaranth", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.RED)), List.of(3, 2, 2)),
	...
	BWG_BISTORT = bwgFlower("bistort", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 2, 1)),

	BWG_BLACK_ROSE = bwgFlower("black_rose", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.BLACK), Items.DYE.pick(DyeColor.BLACK)), List.of(2, 1)),

	BWG_BLUE_SAGE = bwgFlower("blue_sage", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.CYAN)), List.of(2, 1)),

	BWG_CALIFORNIA_POPPY = bwgFlower("california_poppy", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_CROCUS = bwgFlower("crocus", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 2, 1)),

	BWG_CYAN_AMARANTH = bwgFlower("cyan_amaranth", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.CYAN), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.CYAN)), List.of(3, 2, 2)),

	BWG_CYAN_ROSE = bwgFlower("cyan_rose", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.CYAN), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_CYAN_TULIP = bwgFlower("cyan_tulip", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.CYAN), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),

	BWG_DAFFODIL = bwgFlower("daffodil", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.MAGENTA)), List.of(2, 1, 1)),

	BWG_DELPHINIUM = bwgFlower("delphinium", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.BLUE)), List.of(3, 1)),

	BWG_FAIRY_SLIPPER = bwgFlower("fairy_slipper", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.YELLOW)), List.of(2, 2, 1)),

	BWG_FIRECRACKER_BUSH = bwgFlower("firecracker_flower_bush", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.RED)), List.of(3, 2, 2)),

	BWG_FOXGLOVE = bwgFlower("foxglove", List.of(1f, .25f, .25f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.YELLOW)), List.of(2, 1, 1)),

	BWG_GREEN_TULIP = bwgFlower("green_tulip", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.LIME), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_GUZMANIA = bwgFlower("guzmania", List.of(1f, .25f, .25f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.YELLOW)), List.of(2, 1, 1)),

	BWG_HYDRANGEA = bwgFlower("hydrangea_bush", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.WHITE)), List.of(2, 2, 1)),

	BWG_INCAN_LILY = bwgFlower("incan_lily", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.RED)), List.of(2, 1, 1)),

	BWG_IRIS = bwgFlower("iris", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_ORCHID = bwgFlower("japanese_orchid", List.of(1f, .05f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.WHITE)), List.of(2, 1)),

	BWG_PURPLE_SAGE = bwgFlower("purple_sage", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.MAGENTA)), List.of(2, 1)),

	BWG_KOVAN = bwgFlower("kovan_flower", List.of(1f, .2f, .05f),
		List.of(Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.LIME), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1, 1)),

	BWG_LAZARUS_BELLFLOWER = bwgFlower("lazarus_bellflower", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_LOLLIPOP = bwgFlower("lollipop_flower", List.of(1f, .25f, .05f),
		List.of(Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1, 1)),

	BWG_MAGENTA_AMARANTH = bwgFlower("magenta_amaranth", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.MAGENTA)), List.of(3, 2, 2)),

	BWG_MAGENTA_TULIP = bwgFlower("magenta_tulip", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),

	BWG_ORANGE_AMARANTH = bwgFlower("orange_amaranth", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.ORANGE)), List.of(3, 2, 2)),

	BWG_DAISY = bwgFlower("orange_daisy", List.of(1f, .2f, .05f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1, 1)),

	BWG_OSIRIA_ROSE = bwgFlower("osiria_rose", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_PEACH_LEATHER = bwgFlower("peach_leather_flower", List.of(1f, .25f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_PINK_ALLIUM = bwgFlower("pink_allium", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.PURPLE)), List.of(2, 2, 1)),
	...
	BWG_PINK_ANEMONE = bwgFlower("pink_anemone", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.PURPLE)), List.of(2, 2)),

	BWG_PINK_DAFODIL = bwgFlower("pink_daffodil", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.WHITE)), List.of(2, 1, 1)),

	BWG_PROTEA = bwgFlower("protea_flower", List.of(1f, .1f, .05f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.LIME), Items.DYE.pick(DyeColor.PURPLE)), List.of(2, 1, 1)),

	BWG_PURPLE_AMARANTH = bwgFlower("purple_amaranth", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.PURPLE)), List.of(3, 2, 2)),

	BWG_PURPLE_TULIP = bwgFlower("purple_tulip", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),
	...
	BWG_SNOWDROPS = bwgFlower("snowdrops", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.LIME), Items.DYE.pick(DyeColor.WHITE)), List.of(2, 1, 1)),

	BWG_TALL_ALLIUM = bwgFlower("tall_allium", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.MAGENTA)), List.of(3, 2, 2)),

	BWG_TALL_PINK_ALLIUM = bwgFlower("tall_pink_allium", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.MAGENTA)), List.of(3, 2, 2)),

	BWG_VIOLET_LEATHER = bwgFlower("violet_leather_flower", List.of(1f, .25f),
		List.of(Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_WHITE_ANEMONE = bwgFlower("white_anemone", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.LIGHT_GRAY)), List.of(2, 2)),
	...
	BWG_WHITE_SAGE = bwgFlower("white_sage", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.GRAY)), List.of(2, 1)),
	...
	BWG_WINTER_SCILLA = bwgFlower("winter_scilla", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_YELLOW_DAFFODIL = bwgFlower("yellow_daffodil", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.PINK)), List.of(2, 1, 1)),

	BWG_YELLOW_TULIP = bwgFlower("yellow_tulip", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.LIME)), List.of(2, 1)),

	BWG_WHITE_ALLIUM = bwgFlower("white_allium", List.of(1f, .1f, .1f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.LIGHT_GRAY), Items.DYE.pick(DyeColor.GRAY)), List.of(2, 2, 1)),

	BWG_TALL_WHITE_ALLIUM = bwgFlower("tall_white_allium", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.LIGHT_GRAY)), List.of(3, 2, 2)),

	BWG_WHITE_ALLIUM_BUSH = bwgFlower("white_allium_flower_bush", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.LIGHT_GRAY)), List.of(3, 2, 2)),

	BWG_BLUE_ROSE_BUSH = bwgFlower("blue_rose_bush", List.of(1f, .05f, .25f),
		List.of(Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.BLUE)), List.of(3, 2, 2)),

	BWG_HORSEWEED = bwgFlower("horseweed", List.of(1f, 0.25f),
		List.of(Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.BROWN)), List.of(2, 1)),

	BWG_WINTER_SUCCULENT = bwgFlower("winter_succulent", List.of(1f, 0.25f),
		List.of(Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1)),

	BWG_MINI_CACTUS = bwgFlower("mini_cactus", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.GREEN)), List.of(2)),
	...
	BWG_GOLDEN_SPINED_CACTUS = bwgFlower("golden_spined_cactus", List.of(1f, 0.25f),
		List.of(Items.DYE.pick(DyeColor.GREEN), Items.DYE.pick(DyeColor.YELLOW)), List.of(2, 1)),
	...
	ENV_BIRD_OF_PARADISE = envFlower("bird_of_paradise", List.of(1f, .25f, .25f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.RED)), List.of(3, 1, 1)),

	ENV_BLUE_DELPHINIUM = envFlower("blue_delphinium", List.of(1f,.1f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.LIGHT_BLUE)), List.of(3,1)),

	ENV_BLUEBELL = envFlower("bluebell", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.BLUE)), List.of(2)),

	ENV_CARTWHEEL = envFlower("cartwheel", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.ORANGE)), List.of(2, 1)),

	ENV_DIANTHUS = envFlower("dianthus", List.of(1f,.1f),
		List.of(Items.DYE.pick(DyeColor.LIME), Items.DYE.pick(DyeColor.LIME)), List.of(2,1)),

	ENV_MAGENTA_HIBISCUS = envFlower("magenta_hibiscus", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.MAGENTA)), List.of(2, 1)),

	ENV_ORANGE_HIBISCUS = envFlower("orange_hibiscus", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.ORANGE)), List.of(2, 1)),

	ENV_PINK_DELPHINIUM = envFlower("pink_delphinium", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.PINK)), List.of(3, 1)),

	ENV_PINK_HIBISCUS = envFlower("pink_hibiscus", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.PINK)), List.of(2, 1)),

	ENV_PURPLE_DELPHINIUM = envFlower("purple_delphinium", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.PURPLE)), List.of(3, 1)),

	ENV_PURPLE_HIBISCUS = envFlower("purple_hibiscus", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.PURPLE)), List.of(2, 1)),

	ENV_RED_HIBISCUS = envFlower("red_hibiscus", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.RED)), List.of(2, 1)),
	...
	ENV_WHITE_DELPHINIUM = envFlower("white_delphinium", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.WHITE)), List.of(3, 1)),

	ENV_WHITE_LOTUS_FLOWER = envFlower("white_lotus_flower", List.of(1f,.1f),
		List.of(Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.WHITE)), List.of(2,1)),

	ENV_YELLOW_HIBISCUS = envFlower("yellow_hibiscus", List.of(1f, .1f),
		List.of(Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.YELLOW)), List.of(2, 1)),
	...
	TIC_NERCOTIC_BONE = create(Mods.TIC.recipeId("nercotic_bone"), b -> b.duration(100)
		...
		.output(Items.BONE_MEAL, 3)
		.output(.25f, Items.DYE.pick(DyeColor.BLACK))
		.output(.25f, Items.BONE_MEAL, 3)
	...
	UA_FLOWERING_RUSH = create(Mods.UA.recipeId("flowering_rush"), b -> b.duration(50)
		...
		.output(Items.DYE.pick(DyeColor.PINK), 3)
		.output(.25f, Items.DYE.pick(DyeColor.PINK), 2)
	...
	RU_ASTER = ruFlower("aster", List.of(1f, 0.2f, 0.05f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.LIGHT_GRAY)), List.of(2, 1, 1)),

	RU_BLACK_SNOWBELLE = ruFlower("black_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.BLACK)), List.of(2)),

	RU_BLEEDING_HEART = ruFlower("bleeding_heart", List.of(1f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.PINK)), List.of(2, 1)),
	...
	RU_BROWN_SNOWBELLE = ruFlower("brown_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.BROWN)), List.of(2)),

	RU_CACTUS_FLOWER = ruFlower("cactus_flower", List.of(1f, 0.2f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1, 1)),

	RU_CYAN_SNOWBELLE = ruFlower("cyan_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.CYAN)), List.of(2)),

	RU_DAISY = ruFlower("daisy", List.of(1f, 0.2f, 0.05f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_GRAY), Items.DYE.pick(DyeColor.WHITE), Items.DYE.pick(DyeColor.YELLOW)), List.of(2, 1, 1)),

	RU_DAY_LILY = ruFlower("day_lily", List.of(1f, 0.1f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.ORANGE), Items.DYE.pick(DyeColor.LIME), Items.DYE.pick(DyeColor.RED)), List.of(2, 1, 1)),

	RU_DORCEL = ruFlower("dorcel", List.of(1f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.BLACK), Items.DYE.pick(DyeColor.BROWN)), List.of(2, 1)),

	RU_FELICIA_DAISY = ruFlower("felicia_daisy", List.of(1f, 0.2f, 0.05f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE), Items.DYE.pick(DyeColor.BLUE), Items.DYE.pick(DyeColor.WHITE)), List.of(2, 1, 1)),

	RU_FIREWEED = ruFlower("fireweed", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.MAGENTA)), List.of(2)),

	RU_GLITERING_BLOOM = ruFlower("glistering_bloom", List.of(1f, 0.25f, 0.25f),
		List.of(Items.DYE.pick(DyeColor.PINK), Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.LIGHT_BLUE)), List.of(2, 1, 1)),

	RU_GRAY_SNOWBELLE = ruFlower("gray_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.GRAY)), List.of(2)),

	RU_GREEN_SNOWBELLE = ruFlower("green_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.GREEN)), List.of(2)),

	RU_HIBISCUS = ruFlower("hibiscus", List.of(1f, 0.2f),
		List.of(Items.DYE.pick(DyeColor.YELLOW), Items.DYE.pick(DyeColor.RED)), List.of(2, 1)),

	RU_HYSSOP = ruFlower("hyssop", List.of(1f, 0.1f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE), Items.DYE.pick(DyeColor.MAGENTA), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1, 1)),

	RU_LIGHT_BLUE_SNOWBELLE = ruFlower("light_blue_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_BLUE)), List.of(2)),

	RU_LIGHT_GRAY_SNOWBELLE = ruFlower("light_gray_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.LIGHT_GRAY)), List.of(2)),

	RU_LIME_SNOWBELLE = ruFlower("lime_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.LIME)), List.of(2)),
	...
	RU_PURPLE_CONEFLOWER = ruFlower("purple_coneflower", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.PURPLE)), List.of(2)),
	...
	RU_RED_LUPINE = ruFlower("red_lupine", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.RED)), List.of(2)),
	...
	RU_WARATAH = ruFlower("waratah", List.of(1f, 0.2f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.RED), Items.DYE.pick(DyeColor.GREEN)), List.of(2, 1, 1)),

	RU_WHITE_SNOWBELLE = ruFlower("white_snowbelle", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.WHITE)), List.of(2)),
	...
	RU_WILTING_TRILLIUM = ruFlower("wilting_trillium", List.of(1f, 0.1f),
		List.of(Items.DYE.pick(DyeColor.BROWN), Items.DYE.pick(DyeColor.LIGHT_GRAY)), List.of(2, 1)),

	RU_YELLOW_LUPINE = ruFlower("yellow_lupine", List.of(1f),
		List.of(Items.DYE.pick(DyeColor.YELLOW)), List.of(2)),
